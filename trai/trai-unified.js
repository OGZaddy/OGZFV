...
const VoiceVideoIntegration = require('./voice-integration');
...
class TraiQwenStreaming extends EventEmitter {
  constructor(config = {}) {
    ...
    this.voiceVideo = new VoiceVideoIntegration();
    this.wss = null;
...
class TraiClient {
  ...
  async initialize() {
    ...
    try {
      ...
      // Handle WebSocket ping frames from server
      this.ws.on('ping', () => {
        this.ws.pong();
      });
...
// ==========================================
// MAIN EXECUTION - RUN AS SERVER OR CLIENT
// ==========================================

async function startServer() {
  console.log('=' .repeat(50));
  console.log('TRAI SERVER MODE');
  console.log('=' .repeat(50));
...
if (require.main === module) {
  ...
  if (mode === 'server') {
    ...
    console.log('=' .repeat(50));
    console.log('TRAI UNIFIED SYSTEM');
    console.log('=' .repeat(50));
    console.log('Usage: node trai-unified.js [server|client]');
    console.log('');
    console.log('Run in two separate terminals:');
    console.log('Terminal 1: node trai-unified.js server');
    console.log('Terminal 2: node trai-unified.js client');
    console.log('=' .repeat(50));
  }
}
