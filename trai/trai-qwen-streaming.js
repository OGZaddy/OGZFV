// ==========================================
// FILE: trai-qwen-streaming.js
// Trai AI with Qwen3-Coder-30B Streaming Integration
// 24/7 Support, System Monitoring, Sales, Content Creation
// ==========================================
...
if (require.main === module) {
  const trai = new TraiQwenStreaming({
    wsPort: process.env.TRAI_WS_PORT || 3010,  // Unified port 127.0.0.1:3010
    ollamaUrl: process.env.OLLAMA_URL || 'http://127.0.0.1:11434',
    qwenModel: process.env.QWEN_MODEL || 'qwen3-coder:30b'
  });
  
  trai.initialize().catch(console.error);
...
module.exports = TraiQwenStreaming;