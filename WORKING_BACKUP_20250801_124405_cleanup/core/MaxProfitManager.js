...
class MaxProfitManager {
  ...
  constructor(config = {}) {
    ...
    this.config = {
      ...
      firstTierTarget: 0.02,          // 2% profit for first tier
      firstTierExit: 0.25,            // Exit 25% of position
      secondTierTarget: 0.04,         // 4% profit for second tier
      secondTierExit: 0.25,           // Exit another 25%
      thirdTierTarget: 0.06,          // 6% profit for third tier
      thirdTierExit: 0.25,            // Exit another 25%
      finalTarget: 0.10,              // 10% profit for final exit
      
      // --------------------------------------------------------------------
      // TRAILING STOP MANAGEMENT
      // --------------------------------------------------------------------
      enableTrailingStop: true,       // Enable dynamic trailing stops
      initialStopLossPercent: 0.02,   // 2% initial stop loss
      minProfit: 0.015,               // 1.5% minimum profit before trailing
      trailDistance: 0.01,            // 1% trail distance
      tightTrailThreshold: 0.03,      // Tighten trail after 3% profit
      tightTrailDistance: 0.005,      // 0.5% tight trail distance
      breakevenThreshold: 0.005,      // Move to breakeven at 0.5% profit
      
      // --------------------------------------------------------------------
      // TIME-BASED OPTIMIZATIONS
      // --------------------------------------------------------------------
      enableTimeBasedAdjustments: true,     // Enable time-based management
      ...
      // --------------------------------------------------------------------
      enableVolatilityAdjustment: true,     // Enable volatility-based adjustments
