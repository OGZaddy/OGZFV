...
3. Start the backtester (optional):
```bash
...
```bash
open ogz-ultimate-dashboard.html
```

Or use the `.bat` launcher:  
`launch-turbo-train.bat`
...
├── logs/                    # Trading logs
├── OGZPrimeV10.2.js        # Main bot file
├── run-trading-bot-v10.2.js # Bot launcher
